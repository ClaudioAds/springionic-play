...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Categoria cat4 = new Categoria(null, "Higiene e Limpeza");
        Categoria cat5 = new Categoria(null, "Frios");
        Categoria cat6 = new Categoria(null, "Acessórios e Carros");
        ...
        Produto p11 = new Produto(null, "Detergente", 20.00);


        cat1.getProdutos().addAll(Arrays.asList(p1, p2, p3));
        cat2.getProdutos().addAll(Arrays.asList(p2, p4));
        cat3.getProdutos().addAll(Arrays.asList(p5, p6));
        cat4.getProdutos().addAll(Arrays.asList(p1, p2, p5, p7));
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bC.encode("1123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Silva", "ana@gmail.com", "77319653176", TipoCliente.PESSOAFISICA, bC.encode("1123"));
        cli2.getTelefones().addAll(Arrays.asList("27334323", "93862393"));
        cli2.addPerfil(Perfil.ADMIN);

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Floriano", "13", null, "Centro", "38725012", cli2, c2);
